...
if __name__ == "__main__":
    ...
    # 🚨 FIX 3: Start Flask in a non-daemon thread to make the main process wait for it 
    # and ensure the process is not killed prematurely by Render.
    flask_thread = threading.Thread(target=start_flask_server) # Removed daemon=True
    flask_thread.start()
    print("✅ Flask health check server started in background")
    
    # Increased delay to 3 seconds for stability.
    time.sleep(3) 
