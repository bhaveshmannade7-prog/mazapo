...
# ====================================================================
# INITIALIZATION & DATABASE LOGIC (NO CHANGE)
# ====================================================================
...
# ====================================================================
# BOT STATE & SEARCH UTILITIES (NO CHANGE)
# ====================================================================
...
# ====================================================================
# FLASK SERVER (Health Check) (NO CHANGE)
# ====================================================================
...
def start_flask_server():
    ...
    # NOTE: Using '0.0.0.0' for host ensures accessibility on Render
    app_flask.run(host='0.0.0.0', port=WEB_SERVER_PORT, debug=False, use_reloader=False)

# ====================================================================
# MAIN BOT RUNNER (NO CHANGE)
# ====================================================================
...
if __name__ == "__main__":
    ...
    # 🚨 FIX APPLIED: Increased delay to 2 seconds to ensure Flask thread starts properly before main async loop
    time.sleep(2) 
