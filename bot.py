...
async def start_polling_and_run():
    """Start the bot with improved webhook deletion and error logging."""
    ...
    # CRITICAL FIX: Explicitly delete webhook with detailed logging
    print("🔄 Removing any existing webhook configuration...")
    try:
