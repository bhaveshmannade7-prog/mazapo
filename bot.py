...
def start_flask_server():
    ...
    # 🚨 FIX 4: Bind to 0.0.0.0 to ensure Render sees the port
...
# ====================================================================
# MAIN EXECUTION (Controlled by start.sh)
# ====================================================================

# NOTE: The if __name__ == "__main__": block has been removed.
# The startup logic is now controlled by the start.sh script:
# 1. nohup python -c "from bot import start_flask_server; start_flask_server()" &
# 2. python -c "import asyncio; from bot import start_polling_and_run; asyncio.run(start_polling_and_run())"
# This ensures bot polling runs in the main, monitored process.
