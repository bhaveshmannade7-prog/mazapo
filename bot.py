...
FIREBASE_PRIVATE_KEY_STR = os.getenv("FIREBASE_PRIVATE_KEY") # FIXED: Matches the .env name
...
# FATAL CHECK IS UPDATED: Checking for all critical keys.
...
def initialize_db_and_algolia():
    ...
    try:
        ...
        # --- ROBUST FIREBASE KEY HANDLING (The Final Fix) ---
        ...
        # 2. Reconstruct the full credentials dictionary
        cred_dict = {
            "type": "service_account",
            "project_id": FIREBASE_PROJECT_ID,
            "private_key": clean_key_str.replace('\\n', '\n'), # Inject private key and handle newlines
...
# --- CORE LOGIC FUNCTIONS (All subsequent functions remain the same) ---
